...
fun mockResponsePostGraphql(body: String) =
    when {
        ...
        body.contains("25105327167") -> okMockResponse medBody "/dataset/mock/pdl-api-adresser-25105327167.json"
        body.contains("25105327168") -> okMockResponse medBody "/dataset/mock/pdl-api-adresser-25105327168.json"
        else -> defaultResponse
    }
